    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-50 px-4">
      <div className="bg-white p-10 rounded-3xl shadow-xl shadow-slate-200/40 border border-slate-100 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-indigo-600 text-white rounded-xl flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg shadow-indigo-200">
            T
          </div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">TaskFlow'a Giriş Yap</h1>
          <p className="text-slate-500 mt-2 text-sm">Projelerini yönetmeye kaldığın yerden devam et</p>
        </div>
